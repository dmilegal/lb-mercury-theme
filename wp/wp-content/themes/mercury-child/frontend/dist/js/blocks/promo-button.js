...
/* harmony import */ var _shared_scripts_components_tooltip__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/shared/scripts/components/tooltip */ "./src/shared/scripts/components/tooltip.ts");
...
async function onCopy(btn) {
  ...
  try {
    ...
    if (!tp) return;
    const tooltip = await new _shared_scripts_components_tooltip__WEBPACK_IMPORTED_MODULE_1__.LbTooltip(btn, tp, {
      placement: 'bottom',
      offset: 2
    });
    tooltip.show();
...
/******/ var __webpack_exports__ = __webpack_require__.O(undefined, ["libs/chk-promo-button-chk~chk-tooltip-chk-mdl-floating-ui.core-mdl","libs/chk-promo-button-chk~chk-tooltip-chk-mdl-floating-ui.dom-mdl"], () => (__webpack_require__("./src/blocks/promo-button/promo-button.ts")))
