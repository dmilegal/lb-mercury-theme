...
/* harmony import */ var preact__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! preact */ "./node_modules/preact/dist/preact.module.js");
/* harmony import */ var preact_hooks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! preact/hooks */ "./node_modules/preact/hooks/dist/hooks.module.js");
/* harmony import */ var deepsignal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! deepsignal */ "./node_modules/deepsignal/dist/deepsignal.module.js");
    ...
    directives[`on-async-${type}`].filter(({
      ...
      (0,_utils__WEBPACK_IMPORTED_MODULE_2__.useInit)(() => {
        const cb = async event => {
          await (0,_utils__WEBPACK_IMPORTED_MODULE_2__.yieldToMain)();
...
/* harmony import */ var deepsignal__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! deepsignal */ "./node_modules/deepsignal/dist/deepsignal.module.js");
...
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./store */ "./node_modules/@wordpress/interactivity/build-module/store.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./utils */ "./node_modules/@wordpress/interactivity/build-module/utils.js");
...
/* harmony export */ });
/* harmony import */ var deepsignal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! deepsignal */ "./node_modules/deepsignal/dist/deepsignal.module.js");
...
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./hooks */ "./node_modules/@wordpress/interactivity/build-module/hooks.js");
/**
 * External dependencies
 */
...
/* harmony import */ var _preact_signals__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @preact/signals */ "./node_modules/@preact/signals/dist/signals.module.js");
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./hooks */ "./node_modules/@wordpress/interactivity/build-module/hooks.js");
/**
 * External dependencies
 */
...
var bind = __webpack_require__(/*! function-bind */ "./node_modules/function-bind/index.js");
var GetIntrinsic = __webpack_require__(/*! get-intrinsic */ "./node_modules/qs/node_modules/get-intrinsic/index.js");
var setFunctionLength = __webpack_require__(/*! set-function-length */ "./node_modules/qs/node_modules/set-function-length/index.js");
...
var GetIntrinsic = __webpack_require__(/*! get-intrinsic */ "./node_modules/qs/node_modules/get-intrinsic/index.js");
var define = __webpack_require__(/*! define-data-property */ "./node_modules/qs/node_modules/define-data-property/index.js");
var hasDescriptors = __webpack_require__(/*! has-property-descriptors */ "./node_modules/qs/node_modules/has-property-descriptors/index.js")();
var gOPD = __webpack_require__(/*! gopd */ "./node_modules/gopd/index.js");
...
var Modal = /*#__PURE__*/function () {
  function Modal(element) {
    ...
    _defineProperty(this, "handleEscClose", function (event) {
      if (event.key === 'Escape') {
        _this.closeModal();
      }
    });
...
var LbTooltip = /*#__PURE__*/function () {
  function LbTooltip(reference, floating, params) {
    _classCallCheck(this, LbTooltip);
    this.reference = reference;
    this.floating = floating;
    this.params = params;
  }
  _createClass(LbTooltip, [{
    key: "computePosition",
    value: function () {
      var _computePosition2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _this$params = this.params, offset = _this$params.offset, params = _objectWithoutProperties(_this$params, _excluded);
              _context.next = 3;
              return (0,_floating_ui_dom__WEBPACK_IMPORTED_MODULE_0__.computePosition)(this.reference, this.floating, _objectSpread(_objectSpread({}, params), {}, {
...
function _onCopy() {
  _onCopy = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(btn) {
...
(0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__.store)('relinkingList', {
  actions: {
    showMore: function showMore() {
      ...
      context.list = [].concat(_toConsumableArray(context.list), _toConsumableArray(context.listTail));
    }
  }
});
})();
...
function _triggetLoad() {
  _triggetLoad = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
...
function _load() {
  _load = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(query) {
    var res, data;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return fetch("".concat(_shared_scripts_consts__WEBPACK_IMPORTED_MODULE_0__.API_URL, "aces/v1/html/reviews?").concat(query || ''));
        case 2:
          res = _context2.sent;
          _context2.next = 5;
          return res.json();
...
function prepareQuery(query, queryData, data) {
  var _params;
  var params = qs__WEBPACK_IMPORTED_MODULE_3___default().parse(query);
...
function _triggetRefModal() {
  _triggetRefModal = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(container) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          ...
          return _context3.abrupt("return");
        case 7:
          modal = new _shared_scripts_components_modal__WEBPACK_IMPORTED_MODULE_2__.Modal(modalEl);
          modal.openModal();
          _context3.next = 11;
...
document.querySelectorAll('.ez-toc-link').forEach(function (el) {
  el.addEventListener('click', function (e) {
    e.preventDefault();
    var elementWithText = _toConsumableArray(document.querySelectorAll('h1,h2,h3,h4,h5,h6')).find(function (sEl) {
