				<div class="space-archive-loop-item box-100 relative">
					...
					<div class="space-archive-loop-item-img box-20 left relative">
					...
					<div class="space-archive-loop-item-title-box box-80 left relative">
					<?php } else { ?>
					...
					<?php } ?>
						<div class="space-archive-loop-item-title-box-ins relative">
							...
							<div class="space-archive-loop-item-title relative">
								<?php if ( wp_get_attachment_image(get_post_thumbnail_id()) ) {} else {  } ?><a href="<?php the_permalink() ?>" title="<?php the_title_attribute(); ?>"><?php if ( is_sticky() ) { ?><i class="fas fa-paperclip"></i> <?php } ?><?php the_title(); ?></a>
							</div>
