...
?>
<a <?= $attrsStr ?> data-wp-interactive="relinkingItem" class="<?= classNames("lb-relinking-item", "lb-relinking-item--theme_with-primary-image", $className) ?>">
  <? if ($image) { ?>
    <span class="lb-relinking-item__primary-frame">
      <?= wp_get_attachment_image($image, [88, 88], true, [
