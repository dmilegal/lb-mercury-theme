								...
								<?php if ($organization_disable_details == true ) {
									...
									<div class="space-organization-details box-100 relative">
										<div class="space-organization-details-title box-100 relative">
											<h3><?php the_title(); ?> <?php esc_html_e( 'Detalii', 'mercury-child' ); ?></h3>
										</div>
										...
										<div class="space-organization-details-item box-100 relative">
											...
											<div class="space-organization-details-item-links box-66 relative">
												<?php foreach ( $casino_software as $software ) {
													...
													<?php } else {  ?>
														<a><?php echo esc_html($software->name); ?></a>
													<?php } ?>
												<?php } ?>
											</div>
										</div>
										...
										<div class="space-organization-details-item box-100 relative">
											...
											<div class="space-organization-details-item-links box-66 relative">
												<?php foreach ( $casino_deposit_methods as $deposit ) {
													...
													<?php } else {  ?>
														<a><?php echo esc_html($deposit->name); ?></a>
													<?php } ?>
												<?php } ?>
											</div>
										</div>
										...
										<div class="space-organization-details-item box-100 relative">
											...
											<div class="space-organization-details-item-links box-66 relative">
												<?php foreach ( $casino_withdrawal_methods as $withdrawal ) {
													...
													<?php } else {  ?>
														<a><?php echo esc_html($withdrawal->name); ?></a>
													<?php } ?>
												<?php } ?>
											</div>
										</div>
										...
										<div class="space-organization-details-item box-100 relative">
											...
											<div class="space-organization-details-item-links box-66 relative">
												<?php foreach ( $casino_withdrawal_limits as $limit ) {
													...
													<?php } else {  ?>
														<a><?php echo esc_html($limit->name); ?></a>
													<?php } ?>
												<?php } ?>
											</div>
										</div>
										...
										<div class="space-organization-details-item box-100 relative">
											...
											<div class="space-organization-details-item-links box-66 relative">
												<?php foreach ( $casino_currencies as $currency ) {
													...
													<?php } else {  ?>
														<a><?php echo esc_html($currency->name); ?></a>
													<?php } ?>
												<?php } ?>
											</div>
										</div>
										...
										<div class="space-organization-details-item box-100 relative">
											...
											<div class="space-organization-details-item-links box-66 relative">
												<?php foreach ( $casino_devices as $device ) {
													...
													<?php } else {  ?>
														<a><?php echo esc_html($device->name); ?></a>
													<?php } ?>
												<?php } ?>
											</div>
										</div>
